<div class="w-64 h-screen bg-[#A7C7E7] flex flex-col">
    <!-- Logo -->
    <div class="p-6">
    ...
    <nav class="flex-1 px-3">
        @php
            $menuItems = [
                ...
                ['route' => 'summarize.index', 'label' => 'AI Summarize', 'icon' => 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z'],
                ['route' => 'notes.import.form', 'label' => 'Import Catatan', 'icon' => 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10'],
                ['route' => 'categories.index', 'label' => 'Kategori', 'icon' => 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z'],
