...
<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8" x-data="{
        ...
        <h2 class="text-2xl font-bold text-[#1E293B] mb-6">Daftar Akun Baru</h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                <label for="name" class="block text-sm font-medium text-[#1E293B] mb-2">Nama Lengkap</label>
                <input 
                    type="text" 
                    id="name" 
                    name="name" 
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <input 
                        ...
                        required
                        :readonly="otpSent"
                        class="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:border-[#2C74B3] focus:ring-2 focus:ring-[#2C74B3]/20 outline-none transition read-only:bg-gray-50 read-only:cursor-not-allowed"
                    />
                    <button 
                        type="button"
                        @click="
                ...
                <div x-show="error" class="mt-2 bg-red-50 border border-red-200 text-red-600 rounded-lg p-2 text-xs" x-text="error"></div>
                <div x-show="success" class="mt-2 bg-green-50 border border-green-200 text-green-600 rounded-lg p-2 text-xs" x-text="success"></div>
            </div>

            <div x-show="otpSent">
                <label for="otp_code" class="block text-sm font-medium text-[#1E293B] mb-2">
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-medium text-[#1E293B] mb-2">Konfirmasi Password</label>
                <input 
                    type="password" 
            ...
            <div x-show="!otpSent" class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4">
            ...
            <button 
                type="submit"
                :disabled="!otpSent"
                class="w-full bg-[#2C74B3] hover:bg-[#205295] disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium py-3 rounded-xl transition-colors"
            >
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-[#1E293B]/70">
                Sudah punya akun? 
                <a href="{{ route('login') }}" class="text-[#2C74B3] hover:underline font-medium">
                    Masuk di sini
                </a>
            </p>
        </div>
