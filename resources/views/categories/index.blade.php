...
<div class="flex-1 bg-[#F9FAFB] overflow-auto" x-data="categoryManager()">
    <div class="max-w-7xl mx-auto p-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Favorite Category (if exists) -->
            @if($favoritesCount > 0)
                <a href="{{ route('notes.index', ['favorite' => '1']) }}"
                   class="p-6 rounded-2xl border-2 cursor-pointer group relative overflow-hidden transition-all hover:shadow-xl bg-yellow-50 border-yellow-300">
                    ...
                    <div class="flex flex-col items-center text-center relative z-10">
                        <div class="w-20 h-20 rounded-2xl flex items-center justify-center text-4xl shadow-lg mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all bg-yellow-500">
                            <svg class="w-12 h-12 text-white fill-white" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                            </svg>
                        </div>
                        <h3 class="text-lg font-bold text-[#1E293B] mb-2 group-hover:text-yellow-600 transition-colors">
                            Favorit
                        </h3>
                        <p class="text-sm text-[#1E293B]/60">
                            {{ $favoritesCount }} catatan
                        </p>
                    </div>
                </a>
            @endif
